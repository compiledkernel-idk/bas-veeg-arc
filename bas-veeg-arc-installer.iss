...
#define AssetsDir DistDir + "\\assets"
#define IconsDir DistDir + "\\icons"
#define InstallerIcon IconsDir + "\\installer.ico"
#define AppIcon AssetsDir + "\\icons\\app.ico"
...
[Files]
Source: "{#DistDir}\\bas-veeg-arc.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#AssetsDir}\\*"; DestDir: "{app}\\assets"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#IconsDir}\\*"; DestDir: "{app}\\icons"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#LicensePath}"; DestName: "LICENSE.txt"; DestDir: "{app}"; Flags: ignoreversion
